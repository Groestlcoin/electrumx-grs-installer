function install_init {
	...
	cp /tmp/electrumx/contrib/systemd/electrumx-grs.service /etc/systemd/system/electrumx-grs.service
	cp /tmp/electrumx/contrib/systemd/electrumx-grs.conf /etc/
